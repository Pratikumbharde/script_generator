...
export const METHOD_TRAINING = {
  ...
  transactional: {
    emoji: "⚡", origin: "Transactional selling, standard across retail and high-volume B2B.",
    coreIdea: "Short, direct, feature-benefit-close. The buyer already knows what they want — your job is to remove friction and close fast.",
    logic: "No discovery, no deep diagnosis. The buyer has a need and a timeline; you have the product and the price. Efficiency and clarity win. Every extra step is a step where they might leave.",
    whyItConverts: [
      "Speed — the buyer gets what they need without wasted time.",
      "Clarity — pricing, terms, and next steps are obvious from the first minute.",
      "Low friction — the fewer steps between interest and purchase, the higher the close rate.",
    ],
    whyItFails: [
      "Applied to complex sales where the buyer actually needs help figuring out the problem.",
      "No relationship built — the next vendor with a lower price takes the deal.",
      "Assumes the buyer already knows what they want, which is often wrong.",
    ],
    whereRepsLose: [
      "Talking too much — the buyer already knows, just give them the path.",
      "Not having pricing and terms ready — hesitation kills the close.",
      "Skipping the one key question that would have disqualified the deal early.",
    ],
    bestFor: "High-volume B2B, reorder/commodity sales, inside sales teams, products with clear feature-benefit alignment.",
    poorFor: "Complex, multi-stakeholder, or consultative deals where the buyer needs guidance.",
    signatureQuestion: "\"Great — let me get you a price and we can have this wrapped up today. What's your preferred timeline?\"",
  },
  custom: {
    emoji: "🎨", origin: "Your own methodology — no framework, freestyle.",
    coreIdea: "No rigid methodology — you define the approach. Useful for testing your own style against realistic buyers.",
    logic: "Some of the best salespeople blend methods instinctively. This mode lets you write your own prompt and structure, so the AI generates a script that matches your personal style rather than forcing you into a framework.",
    whyItConverts: [
      "Complete flexibility — the script matches your real selling style, not a textbook.",
      "Great for experienced reps who already have a winning pattern.",
      "Perfect for testing new approaches before committing to a methodology.",
    ],
    whyItFails: [
      "Without structure, newer reps may produce vague or unfocused scripts.",
      "No guardrails means the output quality depends entirely on your prompt.",
      "Harder to coach and improve — there's no framework to diagnose what went wrong.",
    ],
    whereRepsLose: [
      "Confusing 'freestyle' with 'no preparation' — you still need to know the product and buyer.",
      "Reinventing the wheel instead of learning from proven methods.",
      "No consistent pattern to analyse and improve over time.",
    ],
    bestFor: "Experienced reps with a proven personal style, coaching scenarios, A/B testing new approaches.",
    poorFor: "New reps who need structure, teams that need consistent messaging across the organisation.",
    signatureQuestion: "\"Before we start — how do you normally run this type of call? I'll build around your style.\"",
  },
};
...
export const CALLTYPE_TRAINING = {
  ...
  negotiation: {
    emoji: "🤝", stage: "Late", typicalLength: "15–30 min",
    goal: "Reach agreement on price, terms, and next steps without giving away value unnecessarily.",
    whenToUse: "After the buyer has seen the product, acknowledged the value, and is now negotiating final terms. They're close — this is about getting the deal done fairly.",
    howToRun: [
      "Start by confirming the value already agreed on — recap the pain, the solution, and the impact.",
      "Never lead with a discount. Lead with value, then trade — every concession gets a concession.",
      "Ask 'what would need to be true for us to sign today?' before offering anything.",
      "Use silence after proposing terms — let them respond first.",
      "Close with a clear, written summary of what was agreed, who does what by when.",
    ],
    goodSignals: ["They negotiate on specific terms (good sign — they want it)", "They involve procurement or legal (means it's real)", "They give you a counter rather than walking away"],
    badSignals: ["'Take it or leave it' without room for discussion", "New stakeholders appearing at the 11th hour", "They won't put anything in writing"],
    mistakes: [
      "Discounting to close instead of trading value for value.",
      "Negotiating against yourself by offering concessions unprompted.",
      "Not having a clear BATNA (best alternative to a negotiated agreement).",
      "Letting the conversation drift to features instead of terms.",
    ],
  },
  objection: {
    emoji: "🛡️", stage: "Any", typicalLength: "5–15 min",
    goal: "Reframe the buyer's concern so they see it differently, not argue them into submission.",
    whenToUse: "When the buyer raises a specific, recurring objection — price, competition, timing, 'we're fine as we are.' This is a focused drill, not a full call.",
    howToRun: [
      "Acknowledge the objection fully before responding — 'I hear you, and that's a fair concern.'",
      "Isolate: 'Is this the only thing holding you back, or is there something else too?'",
      "Reframe: use 'feel-felt-found' or direct reframing — shift the frame from cost to value, from risk to opportunity.",
      "Provide specific proof — case study, data point, or customer quote that directly counters their concern.",
      "Close the loop: 'Does that address your concern, or should we dig deeper?'",
    ],
    goodSignals: ["They say 'that's a good point' or ask a follow-up", "They shift from 'no' to 'how would that work?'", "They move on to the next topic after you reframe"],
    badSignals: ["They repeat the same objection in different words", "They go silent after your reframe", "They bring up a new objection immediately without acknowledging your response"],
    mistakes: [
      "Arguing instead of reframing — you're not here to win a debate.",
      "Not acknowledging the objection before jumping to a response.",
      "Answering the wrong objection — make sure you understood what they actually meant.",
      "Giving a generic answer instead of one tailored to their specific situation.",
    ],
  },
  renewal: {
    emoji: "🔄", stage: "Ongoing", typicalLength: "15–30 min",
    goal: "Secure the renewal and ideally expand — more seats, more features, longer commitment.",
    whenToUse: "30–90 days before a contract expires, or when you proactively want to check in with an existing customer. Also when a customer's usage signals risk (drop in logins, fewer seats, support tickets spiking).",
    howToRun: [
      "Open with genuine interest in their experience — 'How has the last quarter been for you with us?'",
      "Review the value delivered: usage stats, problems solved, outcomes achieved.",
      "Ask what's changed in their world — new team members, new goals, new challenges.",
      "Introduce expansion opportunities naturally — 'I noticed your team grew by 20%, have you considered...'",
      "If there's churn risk, address it directly: 'I want to make sure we're still delivering value. What could we do better?'",
    ],
    goodSignals: ["They volunteer positive feedback unprompted", "They ask about new features or add-ons", "They want to extend the timeline (12 months → 24 months)"],
    badSignals: ["They're avoiding your calls or emails", "Usage has dropped significantly", "They say 'we're evaluating other options'"],
    mistakes: [
      "Treating renewals as automatic — assuming they'll renew without a conversation.",
      "Not knowing the customer's actual usage and outcomes before the call.",
      "Only calling when the contract is about to expire — build the relationship throughout the year.",
      "Focusing on the renewal paperwork instead of the value conversation.",
    ],
  },
};
