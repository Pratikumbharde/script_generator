...
export default function VoiceDNA() {
  ...
  if (docs === null) {
    return (
      <>
        <div className="ps-top"><div><div className="ps-eyebrow">Voice DNA</div><div className="ps-title"><Mic size={22} style={{ marginRight: 8, verticalAlign: "-3px" }} />Voice DNA</div></div></div>
    ...
    <>
      <div className="ps-top">
        <div>
          ...
          <div className="ps-title"><Mic size={22} style={{ marginRight: 8, verticalAlign: "-3px" }} />Voice DNA</div>
          ...
          {!profile ? (
            ...
            <div className="vdna-profile">
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
                <div className="vdna-profile-title">Your Voice DNA Profile</div>
