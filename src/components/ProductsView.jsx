    ...
    <>
      ...
      <div className="ps-body">
        ...
        {showFilters && products.length > 0 && (
          <div className="dt-filter-panel" style={{ marginBottom: 14, display: "flex", alignItems: "center", gap: 10, flexWrap: "nowrap" }}>
            {/* Left: badges + ⓘ */}
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
              <label style={{ fontSize: 12, fontWeight: 600, color: "var(--muted)", whiteSpace: "nowrap" }}>Status</label>
